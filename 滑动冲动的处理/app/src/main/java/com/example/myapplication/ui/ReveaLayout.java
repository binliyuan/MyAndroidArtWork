...
public class ReveaLayout extends LinearLayout implements Runnable{
    ...
    public ReveaLayout(Context context) {
        super(context);
        init();
    }

    public ReveaLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ReveaLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
